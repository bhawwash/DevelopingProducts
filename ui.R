...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(width=3,
      h4("Description"),
      p("This app shows the results of using K-Means to cluster mtcars Dataset. You can change the number of clusters and/or the type of algorithm. Moreover, you can select which features to show. You can compare the performance using the vlidation metrics"),
